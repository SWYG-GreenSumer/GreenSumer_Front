...
const Nav: FunctionComponent<Props> = () => {
  ...
  return (
    <nav className='sticky top-0 bg-white z-10 w-[95%] sm:w-4/5 m-auto'>
      <div className='navbar relative m-auto text-neutral border-b-2 border-[#DEDEDE]'>
        {/* 좌 햄버거 아이콘 */}
        ...
        <div className='absolute right-0 gap-2'>
          {/* 사용자 ID */}
          <div className='text-primary flex-none sm:flex'>
            USER ID
          </div>
          {/* 사용자 프로필 */}
